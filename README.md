# OSIsoft Cloud Services Client Credentials Java Sample
...
This sample is meant to be very simple and straightforward to show how you can use common Java library calls to authenticate against OCS.  In a more complete application you should reuse the bearer token as appropriate and only reissue a new token when it is about to timeout.  
