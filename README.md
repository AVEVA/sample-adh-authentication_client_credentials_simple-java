# CONNECT data services Client Credentials Java Sample

**Version:** 1.0.5

[![Build Status](https://dev.azure.com/AVEVA-VSTS/Cloud%20Platform/_apis/build/status%2Fproduct-readiness%2FADH%2FAVEVA.sample-adh-authentication_client_credentials_simple-java?repoName=AVEVA%2Fsample-adh-authentication_client_credentials_simple-java&branchName=main)](https://dev.azure.com/AVEVA-VSTS/Cloud%20Platform/_build/latest?definitionId=16190&repoName=AVEVA%2Fsample-adh-authentication_client_credentials_simple-java&branchName=main)

Developed against Maven 3.6.3 and Java 15.0.2
...
This sample is meant to be very simple and straightforward to show how you can use common Java library calls to authenticate against Cds.  In a more complete application you should reuse the bearer token as appropriate and only reissue a new token when it is about to timeout.  
